...
{
    /// <summary>
    /// MyDockLayout : 利用Dock属性进行布局
    /// </summary>
    public class MyDockLayout : Panel
    {
        // 左、上、右、下
        ...
        [Browsable(true)]
        [Editor(typeof(MyDockFlagEditorType), typeof(UITypeEditor))]
    ...
    /// </summary>
    class MyDockFlagEditorType : UITypeEditor
    {
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (context != null && context.Instance != null && provider != null)
            {
                ...
                {
                    // 自定义控件
                    MyDockLayout owner = (MyDockLayout)context.Instance;
                    MyDockFlagEditor editorUi = new MyDockFlagEditor();
    ...
    /// </summary>
    [ToolboxItem(false)]
    class MyDockFlagEditor : UserControl
    {
